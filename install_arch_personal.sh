...
sudo pacman -S i3-wm polybar rofi feh ttf-jetbrains-mono-nerd python-pywal maim xclip xdotool pcmanfm ttf-bitstream-vera emptty brightnessctl st ark vscodium autotiling
